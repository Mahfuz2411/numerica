...
export default function TicTacToeScoresPage() {
      ...
      <CardContent>
        {isLoading ? (
          ...
          <p className="text-center text-muted-foreground py-8">
            No scores yet. Play a game to see your history!
          </p>
        ) : (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold">
                      Winner: {score.metadata?.winner || "Unknown"}
                    </p>
                    <p className="text-xs text-muted-foreground">
                      Mode: {score.metadata?.mode === "ai" ? "vs AI" : "2 Players"}
                    </p>
                  </div>
                </div>
