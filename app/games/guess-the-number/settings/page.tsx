...
export default function GuessTheNumberSettingsPage() {
  ...
  const handleClearScores = async () => {
    try {
      ...
      localStorage.removeItem(`${GAME_ID}-best-moves`)
      localStorage.removeItem(`${GAME_ID}-games-played`)
      localStorage.removeItem(`${GAME_ID}-last-achievement`)
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Customize your guessing experience</CardDescription>
      </CardHeader>
