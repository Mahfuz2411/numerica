...
export function GameNavigation({ gameBasePath, gameName, children }: GameNavigationProps) {
  ...
  return (
    <div className="flex flex-col gap-3 sm:gap-4 md:flex-row md:gap-6">
      ...
      >
        <div className="rounded-xl border bg-card/80 p-3 shadow-sm md:p-4">
          <div className="mb-3 flex items-center justify-between gap-2 md:block">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-md border bg-background px-2 py-1 text-xs font-medium hover:bg-accent md:hidden"
            >
          ...
          <button
            type="button"
            onClick={handleExitClick}
            className="mt-3 hidden w-full items-center justify-center gap-2 rounded-lg border bg-background px-3 py-2 text-sm font-medium transition-colors hover:bg-accent md:inline-flex"
          >
